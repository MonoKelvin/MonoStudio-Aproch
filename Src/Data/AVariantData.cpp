...
AVariantDataManager::AVariantDataManager(QObject *parent)
    : AAbstractDataManager(parent), m_constraintSubValue(QLatin1String("constraint")), m_singleStepSubValue(QLatin1String("singleStep")), m_decimalsSubValue(QLatin1String("decimals")), m_enumIconsSubValue(QLatin1String("enumIcons")), m_enumNamesSubValue(QLatin1String("enumNames")), m_flagNamesSubValue(QLatin1String("flagNames")), m_maximumSubValue(QLatin1String("maximum")), m_minimumSubValue(QLatin1String("minimum")), m_regExpSubValue(QLatin1String("regExp"))
{
