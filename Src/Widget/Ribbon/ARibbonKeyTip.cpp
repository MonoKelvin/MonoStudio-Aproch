...
void RibbonKeyTip::hideAndDestroy()
{
 ...
 void RibbonKeyTip::setVisible(bool visible)
 {
...
void RibbonKeyTip::paintEvent(QPaintEvent* event)
{
    ...
    if (d.m_enabled)
        ...
        opt.state &= ~QStyle::State_Enabled;
    style()->drawPrimitive(static_cast<QStyle::PrimitiveElement>(CommonStyle::PE_RibbonKeyTip), &opt, &p, this);
